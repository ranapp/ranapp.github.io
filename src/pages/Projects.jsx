        ...
        <>
            <div className="projects-container">
                <div className="projectcard">
                    ...
                    <img className="project-img" id="img1" src={collegesuccess} alt=""></img>
                    <img className="project-img"  id="img2" src={collegesuccess2} alt=""></img>
                    </div>
                    <p className="tools"> <span class="bold-text"><span class="bold-text">Tools/Technologies Used: </span> </span> Python (Matplotlib, Numpy, Scikit-learn, Flask), JupyterNotebooks, Git</p>
          ...
          height: '1px',
                ...
                <div className="projectcard">
                    ...
                    <img className="project-img" id="img3" src={congrads1}alt=""></img>
                    <img className="project-img" id="img4" src={congrads2}alt=""></img>
                    </div>
                    <p className="tools"> <span class="bold-text"><span class="bold-text">Tools/Technologies Used: </span> </span>Python, React, Node.js, Express.js, MongoDB, Google OAuth 2.0, HTML/CSS, Git</p>
                    <div className="description">
          ...
          height: '3px',
                ...
                <div className="projectcard">
                    ...
                    <img className="project-img" id="img5" src={genglab}alt=""></img>
                    <p className="tools"><span class="bold-text"><span class="bold-text">Tools/Technologies Used: </span> </span>Python (Numpy, Scipy, Seaborn, Scikit-learn), JupyterNotebooks</p>
                    <div className="description">
          ...
          height: '3px',
                ...
                <div className="projectcard">
                    ...
                    <p className="tools"><span class="bold-text"><span class="bold-text">Tools/Technologies Used: </span> </span> Javascript, React, Node.js, Express</p>
                    <div className="description">
          ...
          height: '3px',
                ...
                <div className="projectcard">
                    ...
                    <p className="tools"><span class="bold-text">Tools/Technologies Used: </span> R, Git</p>
                    <div className="description">
          ...
          height: '3px',
                ...
                <div className="projectcard">
                    ...
                    <img className="project-img" id="img8" src={artruism}alt=""></img>
                    <p className="tools"><span class="bold-text">Tools/Technologies Used: </span> Javascript, Next.js, CSS</p>
                    <div className="description">

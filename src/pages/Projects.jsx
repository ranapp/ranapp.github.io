        ...
        <>
          ...
          height: '1px',
                ...
                <div className="projectcard">
                    ...
                    <img className="project-img" src={congrads1}alt=""></img>
                    <img className="project-img" src={congrads2}alt=""></img>
          ...
          height: '3px',
                ...
                <div className="projectcard">
                    ...
                    <img className="project-img" src={genglab}alt=""></img>
          ...
          height: '3px',
                ...
                <div className="projectcard">
                    ...
                    <img className="project-img" src={waterlevels1}alt=""></img>
          ...
          height: '3px',
                ...
                <div className="projectcard">
                    ...
                    <img className="project-img" src={scraping}alt=""></img>
          ...
          height: '3px',
                ...
                <div className="projectcard">
                    ...
                    <img className="project-img" src={artruism}alt=""></img>
